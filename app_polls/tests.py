...
class QuestionModelTests(TestCase):
  ...
  def test_was_published_recently_with_recent_question(self):
    ...
    recent_question = Question(pub_date=time)self.assertIs(recent_question.was_published_recently(), True)
...
class QuestionDetailViewTests(TestCase):
  ...
  def test_past_question(self):
    # the detail view of aquestion with a pub_date in the past displays the question's text
